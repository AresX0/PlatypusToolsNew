...
public partial class EmptyFolderScannerView : UserControl
{
    public EmptyFolderScannerView() => InitializeComponent();
    private async void OnPickClicked(object? sender, RoutedEventArgs e)
    {
        if (DataContext is not EmptyFolderScannerViewModel vm) return;
