...
public partial class ForensicsAnalyzerView : UserControl
{
    public ForensicsAnalyzerView() => InitializeComponent();
    private async void OnPickClicked(object? sender, RoutedEventArgs e)
    {
        if (DataContext is not ForensicsAnalyzerViewModel vm) return;
