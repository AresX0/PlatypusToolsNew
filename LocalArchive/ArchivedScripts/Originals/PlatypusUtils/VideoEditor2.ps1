  ...
  <DockPanel LastChildFill="True">
    <Border DockPanel.Dock="Top" Background="{StaticResource HeaderBrush}" Padding="12" CornerRadius="6" Margin="8">
      <Grid>
        ...
        <TextBlock Grid.Column="1" Text="Video and File Editor" FontSize="16" FontWeight="Bold" Foreground="White" VerticalAlignment="Center"/>
      </Grid>
    </Border>
...
if (Test-Path -LiteralPath (Join-Path $script:AssetsDir 'platypus.png')) { $headerImagePath = Join-Path $script:AssetsDir 'platypus.png' }
